...

{
	...
	const a = [] ; for( lsb = 0 ; lsb <= lsbCount - 1; lsb++){
		for(patch = 0 ; patch <= 127 ;patch++) {
			a.push(`No assign\\USER:${type}:${String(lsb * 128 + patch + 1).padStart(4, '0')}:INIT TONE=${msb},${lsb},${patch}`)
		}
	}
...

{
	...
	const cats = [
		'Pipe Organ', 'Synth Pad/Strings', 'Orchestral', 'Solo Strings', 'Plucked/Stroke', 'Synth FX', 'Sound FX', 'Synth Brass','Vox/Choir', 'Beat&Groove', 'Ac.Piano', 'Pop Piano', 'E.Grand Piano', 'E.Piano1', 'E.Piano2', 'Harpsichord', 'Clav', 'Synth Bellpad', 'Bell', 'Mallet', 'E.Organ', 'Ac.Guitar', 'E.Guitar', 'Dist.Guitar', 'Synth Bass', 'Ensemble Strings', 'Synth Pad/Strings', 'Flute', 'Solo Brass', 'Ensemble Brass', 'Sax', 'Wind', 'Synth Lead', 'Synth PolyKey', 'Synth Seq/Pop', 'Pulsating', 'Hit', 'Ac.Bass', 'E.Bass', 'Accordion', 'Percussion', 'Harmonica', 'Recorder', 'Celesta', 'Scat'
	]
